...
(cl:defmethod cl:initialize-instance :after ((m <LandmarkDistance>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LandmarkDistance)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot3_msgs-msg:<LandmarkDistance> is deprecated: use turtlebot3_msgs-msg:LandmarkDistance instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <LandmarkDistance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot3_msgs-msg:name-val is deprecated.  Use turtlebot3_msgs-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <LandmarkDistance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot3_msgs-msg:distance-val is deprecated.  Use turtlebot3_msgs-msg:distance instead.")
  (distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LandmarkDistance>)))
  ...
  "turtlebot3_msgs/LandmarkDistance")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LandmarkDistance)))
  "Returns string type for a message object of type 'LandmarkDistance"
  "turtlebot3_msgs/LandmarkDistance")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LandmarkDistance>)))
  ...
  (cl:format cl:nil "string name #Name od the landmark~%float64 distance #Distance to the landmark in meters~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LandmarkDistance)))
  "Returns full string definition for message of type 'LandmarkDistance"
  (cl:format cl:nil "string name #Name od the landmark~%float64 distance #Distance to the landmark in meters~%~%"))
